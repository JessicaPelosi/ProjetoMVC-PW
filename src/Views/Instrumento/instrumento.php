...
<html lang="en">
  ...
  <body>
    <main class="container">
        <h1>Instrumento</h1>
        <a href="/instrumento/inserir" class="btn btn-primary">Novo Instrumento</a>
        <p><?= $mensagem ?> </p>
                ...
                <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="/instrumento/alterar/id/<?= $c["id"]?>" class="btn btn-warning">
                                    Alterar
                                </a>
                                <a href="/instrumento/excluir/id/<?= $c["id"]?>" class="btn btn-danger">
                                    Excluir
                                </a>
                            </td>
                        </tr>
