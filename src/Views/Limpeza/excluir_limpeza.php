...
<html lang="en">
  ...
  <body>
    <main class="container">
        ...
        <form action="/limpeza/deletar" method="post">
            <input type="hidden" name="id" value="<?= $resultado['id'] ?>">
            <div class="row">
                <div class="col-6">
                     <label for="aplicacao" class="form-label">Local de aplicação:</label>
                    <input disabled type="text" name="aplicacao" class="form-control" value="<?= $resultado['aplicacao'] ?>">
                </div>
                <div class="col-6">
                ...
                <div class="col-6">
                    ...
                    <input disabled type="text" name="quantidade" class="form-control" value="<?= $resultado['quantidade'] ?>">
                </div>
            </div>
            <div class="row">
                <div class="col">
