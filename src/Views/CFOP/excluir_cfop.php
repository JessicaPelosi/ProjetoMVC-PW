        ...
        <form action="/cfop/deletar" method="post">
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <input type="number" disable name="entradaSaida" class="form-control" value="<?= $resultado['entradaSaida'] ?>">
                </div>
                <div class="col-6">
                    <label for="grupoOuOperacao" class="form-label">Grupo ou Operação:</label>
                    <input type="number" disable name="grupoOuOperacao" class="form-control" value="<?= $resultado['grupoOuOperacao'] ?>">
                </div>
                <div class="col-6">
                    <label for="tipoPrestacao" class="form-label">Tipo da prestação:</label>
                    <input type="number" disable name="tipoPrestacao" class="form-control" value="<?= $resultado['tipoPrestacao'] ?>">
                </div>
            </div>
            <div class="row">
                <div class="col">
